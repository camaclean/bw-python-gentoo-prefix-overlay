...
#CMAKE_REMOVE_MODULES_LIST="FindNetcdf"

S="${WORKDIR}/${PN}${PV}/src"
PATCHES=(
	"${FILESDIR}/${PN}-2.13.2-findnetcdfcxx.patch"
	"${FILESDIR}/${PN}-2.13.0-findpython.patch"
#	"${FILESDIR}/${PN}-2.13.0-findsilo.patch"
	"${FILESDIR}/${PN}-2.13.0-findvtk.patch"
	"${FILESDIR}/${PN}-2.13.0-vtklibs.patch"
	"${FILESDIR}/${PN}-2.13.0-dont_symlink_visit_dir.patch"
	"${FILESDIR}/${PN}-2.13.0-cmakelist.patch"
)
