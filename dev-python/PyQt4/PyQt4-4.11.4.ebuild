...
inherit eutils multibuild multilib python-r1 qmake-utils flag-o-matic
...
src_configure() {
	...
	configuration() {
		...
		#{
		#	echo
		#	echo "QMAKE_CFLAGS += $(portageq envvar CFLAGS)"
		#	echo "QMAKE_CXXFLAGS += $(portageq envvar CXXFLAGS)"
		#	echo "QMAKE_LFLAGS += $(portageq envvar LDFLAGS)"
		#} >> qtdetail.pro

		#echo "eqmake4 -recursive ${PN}.pro `pwd`" >/dev/stderr
