...
IUSE="cray"
DEPEND="|| ( >=dev-python/tensorflow-1.1.0 >=sci-libs/libtensorflow-python-1.1.0 )
virtual/mpi
"
RDEPEND="${DEPEND}"
...
src_configure() {
	...
	append-cflags -I${tensorflow_prefix%/}/usr/include/tensorflow -I${eigen_prefix%/}/usr/include/eigen3-tensorflow -DNDEBUG
	append-cxxflags -I${tensorflow_prefix%/}/usr/include/tensorflow -I${eigen_prefix%/}/usr/include/eigen3-tensorflow -DNDEBUG
