...
if [[ ${PV} == "99999999" ]] ; then
	...
	SRC_URI="mirror://gentoo/eselect-python-20140125.tar.bz2
		https://dev.gentoo.org/~floppym/dist/eselect-python-20140125.tar.bz2"
...
S="${WORKDIR}"/eselect-python-20140125
