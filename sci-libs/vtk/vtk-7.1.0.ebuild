...
REQUIRED_USE="
        all-modules? ( python xdmf2 boost mpi )
        java? ( qt5 )
...
#	cat >ThirdParty/exodusII/CMakeLists.txt  <<-EOF 
#if (NOT VTK_USE_SYSTEM_EXODUSII)
#  set(vtkexodusII_LIBRARIES vtkexoIIc)
#  add_subdirectory(vtkexodusII)
#endif()
#vtk_module_export_info()
#EOF
	#mkdir ThirdParty/exodusII/vtkexodusII
	#ln -s $EPREFIX/usr/include ThirdParty/exodusII/vtkexodusII/include
...
src_configure() {
		...
		#-DvtkexodusII_LIBRARIES="$(get_eprefix sci-libs/exodusii)/lib/exodus.so"
