...
https://github.com/NVlabs/cub/archive/1.4.1.zip -> cub-1.4.1.zip"
...
src_prepare() {
	...
	sed \
		...
		-e "s/GIT_BRANCH=.*/GIT_BRANCH=2.3.1/" \
...
src_configure() {
	...
	export CNTK_COMPONENT_VERSION="2.3.1"
}
