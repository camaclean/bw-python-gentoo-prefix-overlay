...
src_prepare() {
	...
	sed \
		...
		-e "s:/usr/include/json-c:${EPREFIX}/usr/include/json-c:g" \
		-i configure.in || die
...
src_configure() {
	...
	# tiff is a hard dep
	export CFLAGS="${CFLAGS} -I${EPREFIX}/usr/include"
	export CXXFLAGS="${CXXFLAGS} -I${EPREFIX}/usr/include"
	export LDFLAGS="${LDFLAGS} -I${EPREFIX}/usr/include"
