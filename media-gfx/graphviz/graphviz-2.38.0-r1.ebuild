...
IUSE="+cairo cray devil doc examples gdk-pixbuf gtk gts guile java lasi nls pdf perl postscript python qt4 ruby svg static-libs tcl X elibc_FreeBSD"
...
src_prepare() {
	...
	# Fix python site directory for chained prefixes
	sed -i -e "s:PYTHON_INSTALL_DIR=\".*\":PYTHON_INSTALL_DIR=\"$(python_get_sitedir)\":" configure.ac || die
